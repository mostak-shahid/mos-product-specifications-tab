...
const BoxShadowControl = ({ value = {}, onChange, className='' }) => {
    ...
    return (
        <div className={`box-shadow-wrapper ${className}`}>
            <Space align='center'>
                <Switch 
                    aria-label={__('Enable Box Shadow', 'mos-product-specifications-tab')}
            ...
            {shadow.enabled && (
                <Space vertical align='start' className='w-full'>
                    ...
                    />
                    <UnitControl
                        label={__('Spread (px)', 'mos-product-specifications-tab')}
                    ...
                    /> 
                    <div>
                        <label className='font-semibold block mb-1'><Typography.Text>{__('Inset', 'mos-product-specifications-tab')}</Typography.Text></label>
                        <Switch 
                            aria-label={__('Inset', 'mos-product-specifications-tab')}
