        ...
        <BoxedLayout>
            ...
            >
                ...
                <Paragraph style={{marginBottom: 4}}>
                    {__("Unlock the full potential of Product specifications tab for WooCommerce by upgrading to the Pro version. Enjoy advanced features, premium support, and exclusive updates designed to enhance your website.", "mos-product-specifications-tab")}    
                </Paragraph>
                <Paragraph>
                    {__("Don't miss out on the benefits of Product specifications tab for WooCommerce Pro. Upgrade today and take your website to the next level!", "mos-product-specifications-tab")}
                </Paragraph>
