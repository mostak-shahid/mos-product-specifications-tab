...
namespace MosPress\MosProductSpecificationsTab\CLI;
use WP_CLI;

/**
 * Class CLI_Command
 *
 * Handles WP-CLI commands for Product specifications tab for WooCommerce.
 */
class CLI_Command {
     ...
     *     wp mos-product-specifications-tab seed-logs
     *
     *     # Create 50 log entries
     *     wp mos-product-specifications-tab seed-logs --count=50
     *
     ...
     *     wp mos-product-specifications-tab clear-logs
     *
     *     # Clear logs without confirmation
     *     wp mos-product-specifications-tab clear-logs --yes
     *
     * @param array $args       Positional arguments.
     * @param array $assoc_args Associative arguments.
     */
     ...
     *
     *     # Show 10 recent logs
     *     wp mos-product-specifications-tab show-logs
     *
     *     # Show 20 recent logs in JSON format
     *     wp mos-product-specifications-tab show-logs --limit=20 --format=json
     *
     * @param array $args       Positional arguments.
     * @param array $assoc_args Associative arguments.
     */
