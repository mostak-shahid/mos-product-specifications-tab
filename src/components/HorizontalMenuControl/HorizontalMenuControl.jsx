    ...
    return (
        <>
            {isCollapse && breakpoint ? (
                ...
                // --- Desktop (Horizontal) ---
                <Nav
                    className="mos-product-specifications-tab-desktop-horizontal-menu"
                    mode="horizontal"
                    items={items}
            ...
            { breakpoint &&
                <SideSheet
                    ...
                    title={__("Menu", "mos-product-specifications-tab")}
                    closeOnEsc={true}
                    className="mos-product-specifications-tab-phone-horizontal-sidesheet"
                >
                    <Nav
                        className="mos-product-specifications-tab-phone-horizontal-menu"
                        mode="vertical"
                        items={items}
                        selectedKeys={selectedKeys}
                        openKeys={openKeys}
