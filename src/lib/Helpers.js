...
export const formDataPost = async (action, data = {})=> {
    try {
        ...
        const _admin_nonce = mos_product_specifications_tab_ajax_obj?._admin_nonce || '';
        ...
        const response = await apiFetch({
            url: mos_product_specifications_tab_ajax_obj.ajax_url,
            method: 'POST',
            body: formData,
            headers: {
...
export function useSettingsBodyHeight() {
    ...
    useEffect(() => {
        function calculateHeight() {
            ...
            const bannerHeight = getHeight('.mos-product-specifications-tab-promote-banner');
            const headerHeight = getHeight('.mos-product-specifications-tab-header');
            const footerHeight = getHeight('.mos-product-specifications-tab-footer');
