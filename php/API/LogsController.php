...
class LogsController
{
    ...
    {
        global $wpdb;
        $this->logs_table_name = $wpdb->prefix . 'mos_product_specifications_tab_logs';
    }

	public static function log_settings_reset($section, $old_data, $new_data)
	{
		global $wpdb;
		$logs_table_name = $wpdb->prefix . 'mos_product_specifications_tab_logs';
		...
		$wpdb->insert(
			...
			[
                ...
                'category' => __('Settings Reset', 'mos-product-specifications-tab'),
