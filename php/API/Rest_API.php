...
class Rest_API
{
    ...
    public static function rest_feedback($request)
    {
        ...
        //     esc_html__('Error notification for %s', 'mos-product-specifications-tab'),
        //     get_home_url()
        // );
        ...
        wp_mail($email, 'Feedback from Mos Product Specifications Tab', $output, $headers);
        $response = [
            'success' => true,
            'msg' => esc_html__('Email Send successfully.', 'mos-product-specifications-tab'),
            'subject' => $subject,
            'message' => $message
        ];
        return new WP_REST_Response($response, 200);
